...
Зададимся следующими тремя наборами значений $a$ и $b$. Запишем их в виде $(a, b)$ и присвоим каждому набору свой цвет:
\begin{center}
    \begin{tabular}{|c|c|c|}
        \hline
        1 & 2 & 3 \\
...
\begin{tabular}{|c|c|c|c|}
    \hline
     ...
     \hline
      ...
      \hline
      (3, 1)&28.275622 & 28.274334& Да \\
      \hline
        (1, 3)& 1.047016& 1.047198 & Да\\
        \hline
...
\begin{tabular}{|c|c|c|c|}
    ...
    (1, 1)& 1.253314 & 1.253314 & Да \\
      \hline
      (3, 1)&11.279827 &11.279827 & Да \\
      \hline
        (1, 3)&0.723601 & 0.723601 & Да\\
        \hline
...
Для выполнения данного задания выберем функцию двустороннего затухания $f(t) = ae^{-b|t|}$. Набор параметров выберем $a=1$, $b=3$.\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{imgs/originals_g.png}
    \caption{Оригиналы}
    %\label{fig:placeholder}
\end{figure}
...
Для построения графиков образов воспользуемся формулой эйлера $$e^{i\omega c} = \cos(\omega c) + i \sin(\omega c)$$
Тогда образ функции можно записать в виде:
