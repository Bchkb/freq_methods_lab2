...
\begin{center}
    \begin{tabular}{|c|c|c|c|c|}
        ...
        1 & 2 & 3 & 4 & 5\\
        \hline
         (1,1) & (1.5, 0.5) & (0.5, 2) & (1.2, 1.5) & (0.8, 0.8)\\
         \hline
         Синий & Оранжевый & Красный & Зелёный & Фиолетовый\\
         \hline
    \end{tabular}
\end{center}
...
В функции-образе, проявляется свойство масштабирования, связанное с параметром $b$ и свойство линейности, связанное с параметром $a$. Более узкие прямоугольники дают более растянутый образ, так как под функцией синуса находится параметр $b$. С помощью параметра $a$ можно компенсировать амплитуду.
\newpage
...
\begin{figure}[H]
    ...
    \caption{Треугольная функция}
    %\label{fig:placeholder}
\end{figure}


В данном случае снова действует свойство масштабирования на параметре $b$, а параметр $a$ показывает свойство линейности. На графиках видно, что более узким оригиналам соответствуют более растянутые образы, на это влияет параметр $b$. Параметр $a$ снова отвечает за амплитуду.\\
...
В данном случае получается операция, обратная пункту 1. Параметр $b$ снова отражает свойство масштабирования. Параметр $a$ влияет на амплитуду и отражает свойство линейности.\\
...
Параметр $a$ отражает свойство линейности, а параметр $b$ - масштабирования.\\
...
\begin{figure}[H]
    ...
    \caption{Двустороннее затухание}
    %\label{fig:placeholder}
\end{figure}
...
\begin{tabular}{|c|c|c|c|}
    \hline
     $(a, b)$& $\int\limits_{-\infty}^{\infty} |f(t)|^2 dt$ & $\int\limits_{-\infty}^{\infty}|f(\omega)|^2d\omega$ & Приблизительно равны\\
     \hline
      (1, 1)& 2.0 & 2.000091 & Да \\
      \hline
      (1.5, 0.5)& 2.25& 2.250237& Да \\
      \hline
        (0.5, 2)& 1.0 & 1.000082 & Да\\
        \hline
        (1.2, 1.5)& 4.32 & 4.320921 & Да\\
        \hline
        (0.8, 0.8)& 1.024 & 1.02382 & Да\\
        \hline
\end{tabular}
\end{center}
...
\begin{tabular}{|c|c|c|c|}
    \hline
     ...
     \hline
      ...
      \hline
      (1.5, 0.5)& 0.75& 0.75& Да \\
      \hline
        (0.5, 2)& 0.333333& 0.333333 & Да\\
        \hline
        (1.2, 1.5)& 1.44 & 1.44 & Да\\
        \hline
        (0.8, 0.8)& 0.341333 & 0.341333 & Да\\
        \hline
\end{tabular}
\end{center}
\textbf{3. Кардинальный синус}\\
...
\begin{tabular}{|c|c|c|c|}
    \hline
     ...
     \hline
      ...
      \hline
      (1.5, 0.5)&14.138658 & 14.137167& Да \\
      \hline
        (0.5, 2)& 0.392731& 0.392699 & Да\\
        \hline
        (1.2, 1.5)&3.016572  & 3.015929 & Да\\
        \hline
        (0.8, 0.8)& 2.512833 & 2.513274 & Да\\
        \hline
\end{tabular}
\end{center}
\textbf{4. Функция Гаусса}\\
...
\begin{tabular}{|c|c|c|c|}
    ...
    $(a, b)$& $\int\limits_{-\infty}^{\infty} |f(t)|^2 dt$ & $\int\limits_{-\infty}^{\infty}|f(\omega)|^2d\omega$ & Приблизительно равны\\
    \hline
    (1, 1)& 1.253314 & 7.874805 & Да \\
      \hline
      (1.5, 0.5)&3.988021 &25.057476 & Да \\
      \hline
        (0.5, 2)&0.221557 & 1.392082 & Да\\
        \hline
        (1.2, 1.5)& 1.47359 & 9.258842& Да\\
        \hline
        (0.8, 0.8)& 0.896799 & 5.634752 & Да\\
        \hline
\end{tabular}
\end{center}
...
\begin{tabular}{|c|c|c|c|}
    \hline
     ...
     (1, 1)& 1.0 & 1.0& Да \\
      ...
      (1.5, 0.5)&4.5 & 4.5& Да \\
      \hline
        (0.5, 2)& 0.125& 0.125 & Да\\
        \hline
        (1.2, 1.5)& 0.96 & 0.96 & Да\\
        \hline
        (0.8, 0.8)& 0.8 & 0.8 & Да\\
        \hline
\end{tabular}
...
Проведя вычисления, мы видим, что для всех функций выполняется равенство Парсеваля с некоторой допустимой точностью.

\newpage
\section*{Задание 2. Комплексное}

Для выполнения данного задания выберем функцию двустороннего затухания $f(t) = ae^{-b|t|}$. Набор параметров выберем $a=1.5$, $b=0.5$.\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{imgs/org.png}
    \caption{Оригиналы}
    %\label{fig:placeholder}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{imgs/re_fix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{imgs/im_fix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{imgs/g_fix.png}
